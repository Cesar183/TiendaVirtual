...
import com.app.tiendavirtual.databinding.ItemProductoCBinding
...
class AdaptadorProductosC : RecyclerView.Adapter<AdaptadorProductosC.HolderProducto> {
    ...
    private fun visualizarDescuento(modeloProducto: ModeloProducto, holder: AdaptadorProductosC.HolderProducto) {
    ...
    private fun cargarPrimeraImg(
        ...
        holder: AdaptadorProductosC.HolderProducto
    ) {
        val idProducto = modeloProducto.id
        val ref = FirebaseDatabase.getInstance().getReference("Productos")
