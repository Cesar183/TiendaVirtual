...
import com.app.tiendavirtual.databinding.ActivityRegistroClienteBinding
...
class RegistroClienteActivity : AppCompatActivity() {
    ...
    private fun validarInformacion() {
        ...
        if (nombres.isEmpty()){
            ...
            binding.etPassword.error = "Necesita mas de 6 caracteres"
            binding.etPassword.requestFocus()
    ...
    private fun insertarInfoBD() {
        ...
        datosCliente["nombresC"] = "$nombresC"
        ...
        reference.child(uid!!)
            ...
            .addOnFailureListener {e ->
                progressDialog.dismiss()
                Toast.makeText(this, "Falló el registro debido a ${e.message}", Toast.LENGTH_LONG).show()
            }
    }
}